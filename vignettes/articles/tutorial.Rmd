...
Uploading can for example be achieved through the [website](https://www.openml.org).
...
This can either be achieved through the OpenML [website](https://www.openml.org) or through the REST API.
