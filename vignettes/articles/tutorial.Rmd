...
In order to manually create an `mlr3proba::TaskSurv`, we use `mlr3proba::as_task_surv` and pass the data, task id and other metadata required to create the task.
If:
...
```
```{r, eval = FALSE}
## <TaskSurv:otask_surv$data$data> (432 x 9)
## * Target: week, arrest
## * Properties: -
## * Features (7):
