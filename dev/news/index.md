...
- Added
  [`list_oml_collections()`](https://mlr3oml.mlr-org.com/dev/reference/list_oml.md)
...
- Renamed the sugar functions from:
  - [`oml_data()`](https://mlr3oml.mlr-org.com/dev/reference/oml_data.md)
    is now [`odt()`](https://mlr3oml.mlr-org.com/dev/reference/odt.md)
  - [`oml_task()`](https://mlr3oml.mlr-org.com/dev/reference/oml_task.md)is
    now [`otsk()`](https://mlr3oml.mlr-org.com/dev/reference/otsk.md)
  - [`oml_flow()`](https://mlr3oml.mlr-org.com/dev/reference/oml_flow.md)
    is now [`oflw()`](https://mlr3oml.mlr-org.com/dev/reference/oflw.md)
  - [`oml_run()`](https://mlr3oml.mlr-org.com/dev/reference/oml_run.md)
    is now `orn`
  - [`oml_collection()`](https://mlr3oml.mlr-org.com/dev/reference/oml_collection.md)
    is now [`ocl()`](https://mlr3oml.mlr-org.com/dev/reference/ocl.md)
...
- More functions to list objects from OpenML:
  - [`list_oml_evaluations()`](https://mlr3oml.mlr-org.com/dev/reference/list_oml.md)
  - [`list_oml_flows()`](https://mlr3oml.mlr-org.com/dev/reference/list_oml.md)
  - [`list_oml_measures()`](https://mlr3oml.mlr-org.com/dev/reference/list_oml.md)
  - [`list_oml_runs()`](https://mlr3oml.mlr-org.com/dev/reference/list_oml.md)
  - [`list_oml_setups()`](https://mlr3oml.mlr-org.com/dev/reference/list_oml.md)
