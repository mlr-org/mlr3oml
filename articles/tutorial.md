...
- [`publish_data()`](https://mlr3oml.mlr-org.com/reference/publish_data.md)
  to upload a dataset,
- [`publish_task()`](https://mlr3oml.mlr-org.com/reference/publish_task.md)
  to create a task, and
- [`publish_collection()`](https://mlr3oml.mlr-org.com/reference/publish_collection.md)
