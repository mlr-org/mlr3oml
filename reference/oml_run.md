...
- A [OMLTask](https://mlr3oml.mlr-org.com/reference/oml_task.md) is
  returned by accessing the active field `$task`.

- A [OMLData](https://mlr3oml.mlr-org.com/reference/oml_data.md) is
  returned by accessing the active field `$data` (short for
  `$task$data`)

- A [OMLFlow](https://mlr3oml.mlr-org.com/reference/oml_flow.md) is
...
- `flow`:
  ...
  ([OMLFlow](https://mlr3oml.mlr-org.com/reference/oml_flow.md))  
  The OpenML Flow.
